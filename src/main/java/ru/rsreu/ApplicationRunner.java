...
public class ApplicationRunner {
    public static void main(String[] args) throws NotEnoughMoneyException {
        ...
        exchange.putMoney(new ClientAccountOperationDto(secondClient, Currency.USD, BigDecimal.valueOf(500)));
        System.out.println(firstClient.getAccount());
        System.out.println(secondClient.getAccount());
        exchange.registerNewOrder(new Order(secondClient, Currency.USD, Currency.RUR, BigDecimal.valueOf(1200), BigDecimal.valueOf(1.0/58)));
